            ...
            <h2 class="title-section"><span>What They Say</span></h2>
             ...
             <div class="testimonial-container swiper-container">
                ...
                <?php while( $the_query->have_posts() ): $the_query-> the_post();?> 
                    ...
                    <?php
                        //Gather Meta Box Values
                        $the_client = get_post_meta( get_the_ID(), 'testimonial_client_name', true );
                        $the_company = get_post_meta( get_the_ID(), 'testimonial_client_company_name', true );
                        $the_website = get_post_meta( get_the_ID(), 'testimonial_client_company_website', true ); 
                    ?>
